...
private:
    ...
    WaitingVehicles _waitingVehicles;                // list of all waiting vehicles and their associated promises
    TrafficLight _trafficLight;                      // one single traffic light for this intersection
